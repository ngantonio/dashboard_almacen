        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-align-justify"></i> Roles de Acceso
                        ...
                        <tbody>
                          <!-- hacemos un for para iterar por todas las categorias -->
                            <tr v-for="role in arrayRole" :key="role.id">
                                <!--Opciones -->
                                <td>
                                     <!--boton para desactivacion -->
                                    <template v-if="role.active">  
                                      <button @click="desactivar(role.id)" type="button" class="btn btn-danger btn-sm">
                                          <i class="icon-trash"></i>
                                      </button>
                                    </template>
                                    <!--si el producto está desactivado se muestra este boton para permitir activarlo-->
                                    <template v-else>  
                                      <button @click="activar(role.id)" type="button" class="btn btn-info btn-sm">
                                          <i class="icon-check"></i>
                                      </button>
                                    </template>
                                </td>
                                <td v-text="role.rolename"></td>
    ...
    export default {
      ...
      methods :{
        ...
        listar(page, text, criteria){
          ...
          let url = '/role?page=' + page + '&search='+ text + '&criteria='+ criteria;
